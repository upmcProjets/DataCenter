...
extends OfferedI, RequiredI 
{
	...
	// return l URI du port de connection
	
	/**
	 * connecte le port de notification du<code>RequestGenerator</code> au
	 *  composant <code>RequestDispatcher</code> et retourne l'uri du port de soumission
	 *  de ce dernier . 
	 * 
	 * 
	 ...
	 * @throws Exception
	 */
	public String submitApplication(String rgNotificationInboundPort, int nbVm) 
			throws Exception ;
